...
local cosSwapOwned = ""
local cosSwapWanted = ""
WorldRight:CreateTextbox({ Name = "Owned Cosmetic", Placeholder = "PureLove",
    Callback = function(v) cosSwapOwned = v end })
WorldRight:CreateTextbox({ Name = "Wanted Cosmetic", Placeholder = "ToxicInferno",
...
WorldRight:CreateButton({ Name = "Revert to Original",
    Callback = function()
