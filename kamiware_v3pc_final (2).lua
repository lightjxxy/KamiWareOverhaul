...
local LagswitchFreezeDuration = 3000   -- milliseconds
...
local function activateLagswitch()
    ...
    notify("Lagswitch: FREEZE for " .. tostring(LagswitchFreezeDuration) .. "ms", 2)
    ...
    task.delay(LagswitchFreezeDuration / 1000, function()
