...
local FFlagFreezeDuration    = 3000    -- milliseconds
...
local function activateFFlagLagswitch()
    ...
    notify("FFlag Lagswitch: FREEZE for " .. tostring(FFlagFreezeDuration) .. "ms", 2)
    pcall(function()
    ...
    task.delay(FFlagFreezeDuration / 1000, function()
